        ...
        <nav className="nav">
          <div className="nav-container">
            ...
            <div className="nav-actions">
              <Button variant="ghost" size="icon" onClick={cycleTheme} className="theme-switcher">
                {getThemeIcon()}
              </Button>
              ...
              <CardContent>
                <form className="contact-form">
                  ...
                  <div className="form-group">
                    ...
                    <textarea id="message" name="message" rows={5} required className="form-textarea"></textarea>
                  </div>
